...
import {PinConfigurator} from "../../shared/pin-configurator.interface";
...
export class SelectorComponent {
  public pinList: {
    title: string; id: string; pin: { key: string; title: string; options: PinConfigurator[],  withGround?: number }[]
  }[] = [
    {
  ...
  public select(id: string): void {
    this.pinSelectedService.select(id);
  }
}
